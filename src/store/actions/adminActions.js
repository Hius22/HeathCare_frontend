...
export const getAllRequiredDoctorInfor = () => {
    return async (dispatch, getState) => {
        try {
            ...
            let resClinicName = await getALLCodeService("CLINIC_NUMBER");
            let resClinicAddress = await getALLCodeService("CLINIC_ADDRESS");
            ...
            if (resPrice && resPrice.errCode === 0 &&
                ...
                let data = {
                    ...
                    resClinicName: resClinicName && resClinicName.errCode === 0 ? resClinicName.data : [],
                    resClinicAddress: resClinicAddress && resClinicAddress.errCode === 0 ? resClinicAddress.data : [],
                }
